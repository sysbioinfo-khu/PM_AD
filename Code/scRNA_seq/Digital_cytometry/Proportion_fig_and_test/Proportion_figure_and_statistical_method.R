...
setwd('/home/yang/PM_AD/Submission/Code/scRNA_seq/Digital_cytometry/Proportion_fig_and_test')

# Load the data for the proportion plot (test_mean.txt file)
data = read.csv("/home/yang/PM_AD/Submission/Figure_4/Figure/Proportion/test_mean.txt", row.names = 1)
...
data = read.csv("/home/yang/PM_AD/Submission/Figure_4/Figure/Proportion/test.txt")
